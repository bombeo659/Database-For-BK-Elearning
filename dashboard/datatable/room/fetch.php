...
foreach ($result as $row) {
    ...
    <div class="btn-group" role="group" aria-label="Basic example">
        <a type="button" class="btn btn-secondary btn-sm rounded " href="room_announcement?room_ID=' . $row["room_ID"] . '">View</a>
        <button type="button" class="btn btn-primary btn-sm rounded mx-1 edit" id="'.$row["room_ID"].'">Edit</button>
        <button type="button" class="btn btn-danger btn-sm rounded delete" id="'.$row["room_ID"].'">Delete</button>
    </div>';
